...
8. When practical, record the primary photo and parcel-map source/reference/date in the property Markdown record. Do not download or commit third-party listing/satellite image files to this repository by default.
...
20. Create or update the corresponding Markdown property record using `property-template.md`.

The property Markdown file is the durable factual record. Persona files define scoring lenses. Benchmark files define reference points. Finance files define buyer capital assumptions. Conversation is the working research notebook.
