...
- **Rural Dating Catchment (RDC):** read `rural-dating-catchment.md` and calculate RDC-30/RDC-45/RDC-60 when practical. Focus on the suburban dating belt accessible from the rural property rather than the whole MSA; report suburban pool depth, rural-interface quality, date friction, growth direction and confidence. Use women 30–39 as the standardized demographic cohort for cross-market comparison; distinguish unmarried demographic proxies from active daters and preserve ACS uncertainty/MOEs.
- **Dating-market access:** evaluate the realistic dating pool for Nicholas as a 42-year-old heterosexual single man seeking a roughly 34–39-year-old, physically active/fit partner compatible with an outdoors/property-oriented lifestyle. Report a separate **Dating Market Access Score (0–100)** and confidence. Use realistic drive time—not straight-line distance or broad metro labels—and distinguish the nearest service town, regional city and substantial metro pool. Consider population scale, age/sex structure, single/unmarried share when available, transplant/growth dynamics, likely app radius, social/fitness/outdoor venues and travel friction. Treat fitness and compatibility as probabilistic lifestyle proxies, never as census facts or guarantees. Penalize male-heavy markets, very small pools, isolation and locations where routine dates would require burdensome drives.
...
For new-property discovery, prioritize corridors meeting the RDC threshold in `rural-dating-catchment.md` before broad metro/state searches. Properties outside those corridors remain eligible when evidence supports a strong RDC or exceptional investment case.
