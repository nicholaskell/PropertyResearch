---
record_version: 5
address: 16 Eckert Ln
city: Pleasant Shade
state: TN
zip: 37145
county: Smith
parcel_id: "012 00501 000"
listing_url: https://www.zillow.com/homedetails/16-Eckert-Ln-Pleasant-Shade-TN-37145/42369606_zpid/
zillow_url: https://www.zillow.com/homedetails/16-Eckert-Ln-Pleasant-Shade-TN-37145/42369606_zpid/
primary_photo_url:
...
days_on_market: ~45-73 depending portal/list-date convention
...
rights_disturbance_risk: "⚫ UNKNOWN"
...
Primary/hero listing photo was available on Zillow on 2026-09-07 and shows the two-story log home in a wooded/rural setting. Source: Zillow / RealTracs MLS 3250345. Stable direct image URL not recorded.
...
| Carrying costs | CLEAR | Listing reports only $1,554/yr property tax; insurance for log construction must be quoted. |

## Listing & Value

- Current ask: $599,000.
- Current MLS/listing status: active but under contract with a 72-hour kick-out clause.
...
A-1 rules, if applicable, are favorable to farming and ordinary livestock/poultry. The county's kennel definition is commercial/boarding-oriented and references six or more dogs/cats over one year old; three household dogs do not appear to trigger that definition. No HOA is reported. Confirm exact zoning and nuisance/fencing rules, but this is provisionally favorable for three large dogs, chickens, goats/sheep and garden/orchard uses.

## Rights & Restrictions

**Mineral/OGM rights must not be assumed to convey until deed/title evidence confirms them.** Tennessee permits severed mineral interests, and state oil/gas regulators do not adjudicate ownership. The current listing does not establish mineral ownership.

- OGM/minerals: Unknown.
- Coal rights: Unknown.
- Timber rights: Unknown.
- Current rightsholder/operator: Unknown.
- Active leases/units/permits: Not established in this pass.
- Surface-use protections: Unknown.
- Easements/ROW: Unknown.
- HOA/covenants: MLS says no HOA; deed restrictions not reviewed.

### Rights Disturbance Risk

- **Exercise Likelihood:** UNKNOWN
- **Surface/Lifestyle Impact if Exercised:** UNKNOWN; potentially material on a 56-acre rural tract if a severed right includes surface access/use.
- **Overall Rights Disturbance Risk:** ⚫ UNKNOWN
- Most important missing evidence: current warranty deed, title commitment, mineral reservations/exceptions, leases/easements and any recorded surface-use limitations.

## Taxes & Carrying Cost

Current listing reports annual property tax of $1,554 and assessed value of $438,400. This is an unusually attractive carrying-cost feature relative to the purchase price. Verify 2026 assessment/reassessment implications and quote homeowners insurance specifically for a log home, acreage, detached structures and any wood-processing/business activity.

## House / Homesite

The 2006 log home is approximately 2,921 sq ft. Current MLS fields show one bedroom because lower-level bedrooms were removed to create a homeschool/open area; prior 2025 marketing described four bedrooms. Rebuilding bedroom walls appears relatively easy but egress, septic bedroom rating, HVAC and code compliance must be confirmed.

Recent renovation claims materially improve Brittany fit: metal roof, HVAC/mini-split, LVP, appliances, exterior stain/fascia/gutters, deck/roof, septic service and driveway work. Remaining inspection priorities are log condition/rot/insects/chinking, moisture at lower level, foundation/drainage, roof installation, septic permit/design capacity, electrical service, HVAC sizing and insurance availability.

Foreseeable work classification: **Cosmetic to Moderate if inspection confirms the claimed renovations; Major if log/foundation/moisture defects are found.**

## Utilities

- Water: public water per MLS.
- Sewer: septic.
...
- Green Bay, WI: long-distance relocation; roughly 700+ road miles / approximately 11 hours, estimate pending exact routing.
- Nearest service town: Carthage / Pleasant Shade area.
- Lebanon: approximately 32 miles / 44 minutes from Pleasant Shade.
- Nashville: approximately 67 miles / 1 hr 16 min from Pleasant Shade.
- Cookeville: regional market within roughly an hour depending route/property location.
- This is meaningfully more isolated than the Wisconsin search area, but it reaches the Nashville market within about 75-90 minutes.

## Commercial Market Access

- Best 30-minute market: Carthage / local Smith County.
- Best 60-minute market: Lebanon and portions of Cookeville-region demand.
- Best 90-minute market: Nashville metro plus broader Middle Tennessee.
- Best 120-minute market: broad Nashville/Cookeville/Middle Tennessee reach.
- Best opportunities: rural property services, woodworking, specialty lumber/firewood, equipment/property work, but only if Smith County approves the specific on-site business activity.
- Market rating: 🟡/🟢 — excellent regional metro access for a rural property, weaker immediate customer density.

## Nuisances / Surroundings

The listing emphasizes privacy and hilly rural surroundings. No HOA is reported. Specific nearby CAFOs, quarries, pipelines, transmission corridors, shooting ranges or industrial nuisances were not conclusively cleared in this pass. Road grade/access and neighboring residences must be field-checked because they matter for dog safety and noisy shop/wood operations.

## Cost to Goal

- Purchase: $599,000 ask.
- Immediate work: potentially low-to-moderate if renovations inspect well; bedroom reconstruction and inspection-driven corrections likely.
- Desired improvements: meaningful shop/operational yard, fencing, possible Thomas future homesite/utilities.
- Effective Property Cost: not yet reliable; shop/sitework on hilly land could materially increase cost.
...
Not scored. `finance/buyer-finance.md` remains unconfigured, so the active conservative/balanced/aggressive scenarios have no capital inputs to calculate.
...
**Financial Fit: Not Yet Scored.** Buyer finance fields for home-sale proceeds, reserves, down payment and target/max monthly housing cost are blank.
...
- [ ] Verify septic permit/design bedroom capacity before rebuilding bedrooms.
- [ ] Get Smith County written determination for woodworking, firewood processing, sawmilling, outdoor storage, customer traffic and equipment business.
- [ ] Inspect logs/chinking/rot/insects, foundation/drainage, lower-level moisture and all claimed renovation work.
- [ ] Quote log-home insurance and coverage for detached structures/business activities.
- [ ] Confirm pathway for a future second dwelling/lot split for Thomas.
