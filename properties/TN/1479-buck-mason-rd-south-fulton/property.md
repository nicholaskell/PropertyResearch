---
address: 1479 Buck Mason Rd, South Fulton, TN 38257
state: TN
county: Weakley County
parcel_id: "015 028.00"
status: active
list_price: 479900
...
| Item | Status | Notes |
|---|---|---|
| 300+ Mbps wired broadband | **INVESTIGATE** | South Fulton area has fiber/cable footprints, including Gibson Connect fiber, but exact-address eligibility has not been confirmed. Nicholas hard requirement remains open. |
...
**Status: UNCONFIRMED AT EXACT ADDRESS.**

Area-level evidence shows Gibson Connect operates fiber in the broader South Fulton area and currently markets symmetrical 1 Gbps and 3 Gbps tiers where serviceable. Other datasets show additional fiber/cable availability in parts of 38257. This is encouraging but does **not** prove service at 1479 Buck Mason Rd.

**Required next step:** run 1479 Buck Mason Rd through FCC Broadband Map and Gibson Connect's exact-address eligibility tool, then call the provider if the map is ambiguous. Because Nicholas requires reliable 300+ Mbps wired service, do not promote this property to CLEAR until exact-address service is verified.
...
**Existing:** small move-in-capable residence, workshop, carports/equipment cover, public water, septic, 200+ amp power, pasture/fencing, road frontage.
...
At list price, there is not enough evidence of an appraisal/value cushion to justify paying the full $479,900 without acreage/farm comps. A negotiation target should be derived after exact broadband, parcel constraints and comparable farm sales are checked.

## Persona Scores — Preliminary

Scores are intentionally provisional where broadband/zoning/parcel constraints remain unresolved.

| Persona | Score | Read |
|---|---:|---|
| Nicholas | **74/100** | Excellent acreage, privacy, utilities/workshop and expansion concept; broadband hard requirement still unresolved and list price/value is concerning. |
...
| Firewood & Lumber | **82/100** | Strong acreage, workshop/power, road frontage and operational separation; zoning/business legality and customer depth remain open. |
| Greenhouse Business | **77/100** | Strong acreage, public water and long growing season; retail/home-business legality and exact site drainage/solar need verification. Scale-Up Path: **PLAUSIBLE**. |
| Homestead | **91/100** | Former cattle farm, pasture, woods, creek, low taxes and infrastructure are unusually strong. |
| Kell and Son Limited Co. | **83/100** | Excellent physical base for tractors, trailers, shop expansion and wood operations; business-use legality is the gating issue. |
| Resale & Development | **60/100** | Frontage and acreage create optionality, but list-price support, rural liquidity, soils/septic and subdivision rules are unresolved. |
| Thomas | **72/100** | Strong potential for a separate homesite/shop and projects, but second-home legality, septic and broadband are unresolved; regional employment/education market is smaller. |

**Weighted preliminary aggregate:** approximately **78/100**, but this should not be treated as a contender score until the broadband hard requirement is cleared.

## Highest-Value Next Diligence

1. Exact-address FCC + Gibson Connect broadband verification.
2. County parcel/GIS + FEMA/NWI + NRCS soil overlay to quantify constrained/usable acres and identify future homesites.
3. Weakley County confirmation of zoning, second dwelling/subdivision, accessory shops, sawmill/firewood/home-business, greenhouse retail, livestock and dog rules.
4. Survey/title review for exact boundaries, frontage, easements, deed restrictions and mineral/subsurface rights.
5. Septic records and feasibility for additional homesites.
6. Farm/acreage sold comps to establish fair value and offer range.
7. Insurance quote and Greenbelt rollback estimate under likely development scenarios.
...
- Gibson Connect official service information, checked 2026-09-11.
